...
void req(){
   ...
   if ((WiFiMulti.run() == WL_CONNECTED)) {
    ...
    if(mOnstate == 1){
     if(kondisi == 1){
       _url = "http://iot.muraproject.com/php/frommikro.php?mId=ugigofmfjf&mC=1";
     }
     else{
       _url = "http://iot.muraproject.com/php/frommikro.php?mId=ugigofmfjf&mC=0";
    ...
    _url = "http://iot.muraproject.com/php/frommikro.php?mId=ugigofmfjf&mC=q"; 
    }

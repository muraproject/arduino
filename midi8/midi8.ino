/*
   ESP32 Piano with OLED Display and MIDI Player
   - Uses U8g2 for OLED
   - Web interface for MIDI upload and control
...
// Pin Definitions
const int hornPins[6] = {13, 12, 14, 27, 26, 25};  // For horns/notes
const int BUTTON_PREV = 32;  // Previous button
const int BUTTON_PLAY = 33;  // Play button
const int BUTTON_STOP = 34;  // Stop button
const int BUTTON_NEXT = 35;  // Next button

// Global Variables
bool noteStates[6] = {false, false, false, false, false, false};  // Track note states
int currentFileIndex = 0;  // Current file index
String fileList[20];      // List of MIDI files (max 20)
int totalFiles = 0;       // Total number of MIDI files
...
void updateOLEDDisplay() {
  ...
  if (isPlaying) {
    int progress = 126;  // Could be made dynamic based on file position

...
const int hornPins[6] = {13, 12, 14, 27, 26, 25};  // Changed from {5, 18, 19, 21, 22, 23}
bool noteStates[6] = {false, false, false, false, false, false}; // Track note states

// Tombol kontrol
const int BUTTON_PREV = 32;
const int BUTTON_PLAY = 33;
const int BUTTON_STOP = 34;
const int BUTTON_NEXT = 35;
